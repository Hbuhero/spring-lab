...
public class PageableConfig {
    public Pageable pageable(PageableParam pageableParam) {
//        if (pageableParam == null){
//            pageableParam = new PageableParam("id", "DESC", 20, 0);
//        }

        if (
                pageableParam.getSize() == null &&
                pageableParam.getPage() == null &&
                pageableParam.getSortBy() == null &&
                pageableParam.getSortDirection() == null
        ) {
            return Pageable.unpaged(); // Returns all data
        }
        ...
        if (pageableParam.getPage() != null && pageableParam.getPage() > 0) {
            page = pageableParam.getPage() - 1;
        }
